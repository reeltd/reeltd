...
<head>
    ...
    <meta charset="utf-8">
    <meta content="initial-scale=1.2, maximum-scale=1.2, user-scalable=no" name="viewport">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ config('app.name', 'Locked') }} ::Locked::</title>
...
<body class="hold-transition skin-black sidebar-mini fixed">
  ...
  <header style="margin: 0 0 0 0;" class="skin-black main-header">
    <!-- Logo -->
    <a href="/reeltd/locked" class="logo">
...
<footer style="padding-top:180px" class="footer">
    <!-- To the right -->
