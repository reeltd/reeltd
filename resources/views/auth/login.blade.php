...
<div class="login-box">
  ...
  <div class="box box-primary">
    ...
    <!-- /.social-auth-links -->
        ...
        @if (Route::has('password.request'))
            <a style="font-size:12px" class="btn btn-link" href="{{ route('password.request') }}">
                {{ __('Forgot Your Password?') }}
            </a>
        @endif

        @if (Route::has('register'))
            <a style="font-size:12px" class="nav-link" href="{{ route('register') }}"> <i class="glyphicon glyphicon-plus"> </i> {{ __('Create a new account') }}</a>
        @endif
    </div>
  <!-- /.login-box-body -->
</div>
